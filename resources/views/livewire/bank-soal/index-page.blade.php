{{-- resources/views/livewire/bank-soal/index-page.blade.php --}}
<div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {{-- Logika pembagian kolom (misal TPS & Literasi) --}}
                    @php
                        // Pastikan urutan sesuai SNBT yg benar (jika perlu)
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 transform hover:scale-[1.02] transition duration-300">
                        ...
                        <div class="space-y-4">
                            @forelse($tpsSubjects as $subject)
                                <a href="{{ route('bank-soal.show', $subject->slug) }}"
                                   wire:navigate {{-- Gunakan Livewire navigation --}}
                            ...
                            @empty
                                 <p class="text-sm text-gray-500 text-center">Subtes TPS belum tersedia.</p>
                            @endforelse
                        </div>
                    </div>

                    {{-- Kolom Kanan: Literasi & Penalaran --}}
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 transform hover:scale-[1.02] transition duration-300">
                         ...
                         <div class="space-y-4">
                            ...
                            @empty
                                 <p class="text-sm text-gray-500 text-center">Subtes Literasi & Penalaran belum tersedia.</p>
                            @endforelse
                        </div>
                    </div>
